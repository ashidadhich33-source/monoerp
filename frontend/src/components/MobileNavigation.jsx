...
const MobileNavigation = () => {
  ...
  const adminNavItems = [
    ...
    { name: 'Monitoring', href: '/admin/monitoring', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    { name: 'Disaster Recovery', href: '/admin/disaster-recovery', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z' },
    { name: 'Alerting', href: '/admin/alerting', icon: 'M15 17h5l-5 5v-5zM4.828 7l2.586 2.586a2 2 0 102.828 2.828L9.828 12.828a2 2 0 11-2.828-2.828L4.828 7z' },
    { name: 'Integrations', href: '/admin/integrations', icon: 'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1' },
    { name: 'Notifications', href: '/admin/notifications', icon: 'M15 17h5l-5 5v-5zM4.828 7l2.586 2.586a2 2 0 102.828 2.828L9.828 12.828a2 2 0 11-2.828-2.828L4.828 7z' },
    { name: 'Achievements', href: '/admin/achievements', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    { name: 'Rankings', href: '/admin/rankings', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
    ...
    { name: 'Performance', href: '/admin/performance-metrics', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
